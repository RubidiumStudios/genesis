#!/usr/bin/env perl
# Proves T261, T263, and T275: the pull request's title is the aggregate
# commit's own subject and moves with the marker, an open pull request nobody
# has reviewed is rebuilt and its title and body updated, and a branch with
# several pull requests open on it warns and is acted on by what a reviewer
