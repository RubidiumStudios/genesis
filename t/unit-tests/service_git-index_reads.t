#!/usr/bin/env perl
# The three index reads the writer's two assertions are written on.  Each row
# proves that the answer comes from the index rather than from the working
# tree.  That is why the writer checks its postcondition before it commits,
# because at that moment the index is the delivery and the working tree is
