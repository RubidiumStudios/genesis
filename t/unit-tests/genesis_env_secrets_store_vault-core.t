...
subtest 'Defect 4: store_data() handles undef export safely' => sub {
	...
	# suppressed because this file references the fully-qualified name exactly
	# once (at the assignment below), which would otherwise trip the "used
	# only once: possible typo" warning.
