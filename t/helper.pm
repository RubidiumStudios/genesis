...
sub import {
	...
	# Seed $Genesis::VERSION; override via $ENV{GENESIS_TEST_VERSION}
	# for tests whose fixtures pin a specific min_version.
	{
		no warnings 'once';
		$Genesis::VERSION //= $ENV{GENESIS_TEST_VERSION} // '999.999.999';
	}
