...
=item GH-7 (medium) E<mdash> B<RESOLVED>

C<latest_version_of()> now passes C<include_prereleases> (plural) to
C<versions()>, matching the key that C<versions()> checks at line 328.
