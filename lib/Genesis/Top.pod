...
refusal exits C<Genesis::Exit::CONFIG>. A version 2 configuration errors
for every pipeline command, naming the migration, and a C<ci.yml> left
beside a version 3 configuration that enables a pipeline warns that the
file is a stale leftover.
