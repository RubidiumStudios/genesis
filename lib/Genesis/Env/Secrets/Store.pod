...
C<"Abstract Method: Expecting %s class to define concrete '%s' method">
...
=item * C<"Abstract Method: Expecting %s class to define concrete '%s' method">
