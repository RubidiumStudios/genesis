...
C<Genesis::BranchClass::assert_pre_deploy>, which refuses a derived branch
at C<Genesis::Exit::DATAERR>.
...
This function raises none of its own.  It names the branch, the class it
belongs to, and the checkout that fixes it, and it exits
