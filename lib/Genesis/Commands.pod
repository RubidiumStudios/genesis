...
the class it belongs to, and the checkout that fixes it, and it exits
C<Genesis::Exit::DATAERR>.  A remote that cannot be reached for the refresh
exits C<Genesis::Exit::TEMPFAIL>.
...
B<Examples:>
  ...
  # deployment, pull request, or artifacts branch
