...
B<The C<bosh configs> subcommands.>
...
B<All six are currently stubs.> Each prints a diagnostic and returns C<1>;
none touches the director. They are documented for the behaviour they are
intended to have, with the stub state stated on each.
